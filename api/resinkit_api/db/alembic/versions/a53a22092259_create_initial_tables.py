...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'SUBMITTED', 'VALIDATING', 'PREPARING', 'BUILDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLING', 'CANCELLED', name='taskstatus'), server_default=sa.text("'PENDING'"), nullable=False),
    ...
    sa.CheckConstraint("status IN ('PENDING', 'SUBMITTED', 'VALIDATING', 'PREPARING', 'BUILDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLING', 'CANCELLED')", name='valid_task_status'),
    ...
    sa.Column('previous_status', sa.Enum('PENDING', 'SUBMITTED', 'VALIDATING', 'PREPARING', 'BUILDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLING', 'CANCELLED', name='taskstatus'), nullable=True),
    sa.Column('new_status', sa.Enum('PENDING', 'SUBMITTED', 'VALIDATING', 'PREPARING', 'BUILDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLING', 'CANCELLED', name='taskstatus'), nullable=True),
